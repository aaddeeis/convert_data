...
#python coco2voc.py --json_path annotations/annotations.json --output simpan 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_path',type = str ,help = 'path to json file.',default="./annotaions/annotations.json")
